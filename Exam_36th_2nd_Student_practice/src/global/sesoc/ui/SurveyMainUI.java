...
public class SurveyMainUI {
	...
	private void viewSurveyList() {
		// Code Here
		List<Survey> list = dao.viewSurveyList();	 /*SurveyDAOManager 클래스의 viewSurveyList 호출해서 리스트에 담기 */ 
	...
	/**
	 * 설문에 대한 답변 등록
	 *     등록하고자 하는 답변을 입력받아 ArrayList에 저장 후  SurveyDAOManager 클래스의 insertQuestion 호출 --> SurveyMapper의 insertQuestion을 통애 DB에 저장
	 */
